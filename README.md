...
## Reflexion de equipo:
Este proyecto nos encontro con distintos problemas, los cuales algunos de ellos fueron resueltos mediante prueba y error, y otros con ayudas externas. El problema inicial era hacer el pensamiento de como se iban a relacionar las clases, principalmente nos costo entender como distribuir las responsabilidades sin violar los principios como el SRP, y como lograr que las clases se comuniquen de forma clara sin acoplarlas innecesariamente. Otro de los grandes desafios fue respetar los principios SOLID y los patrones GRASP, ya que al ser un proyecto extenso, es dificil de entender donde estan los errores. Estuvimos repensando el diseño, mirando ejemplos de otros ejercicios con varias clases, discutiendo distintas soluciones y mucho prueba y error. Ademas, trabajar en un proyecto tan extenso con personas que uno no conoce tambien se nos hizo dificil la comunicación entre nosotros. Por suerte, supimos charlarlo y prometer empezar a organizar de mejor manera nuestra forma de trabajar en equipo, y por suerte sacamos el proyecto adelante mas organizadamente.
Resumidamente, el proyecto fue una buena instancia para varios aspectos, principalmente mejoramos el trabajo en equipo, ademas, para algunos de nosotros fue el primer gran proyecto en el que participamos, ya que fue un constante interes en revisar todos los dias el codigo, las clases, los diagramas, etc. Por lo que fue una buena experiencia ser parte de este proyecto en el cual no solo se necesita conocimiento del lenguaje, sino que se necesita pensar y razonar las distintas maneras de relacionar las clases.
