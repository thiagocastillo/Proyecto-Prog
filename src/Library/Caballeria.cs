...
// Clase que representa la unidad de Caballería, implementa la interfaz IUnidadMilitar
public class Caballeria : IUnidadMilitar
{
    // Propietario de la unidad
    public Jugador Propietario { get; private set; }
    // Valor de ataque de la caballería
    public int Ataque { get; private set; } = 12;
    // Valor de defensa de la caballería
    public int Defensa { get; private set; } = 7;
    // Velocidad de movimiento de la caballería
    ...
    // Constructor: inicializa la caballería con su propietario
    public Caballeria(Jugador propietario)
    {
        Propietario = propietario;
    }

    // Calcula el daño que esta caballería inflige a otra unidad
