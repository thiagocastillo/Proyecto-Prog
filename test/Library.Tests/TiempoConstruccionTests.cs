...
public class TiempoConstruccionTests
{
    ...
    {
        int tiempo = 5;
        TiempoConstruccion tiempoConstruccion = new TiempoConstruccion(tiempo);
    ...
    {
        TiempoConstruccion tiempoConstruccion = new TiempoConstruccion(3);
    ...
    {
        TiempoConstruccion tiempoConstruccion = new TiempoConstruccion(1); // 1 segundo
    ...
    {
        TiempoConstruccion tiempoConstruccion = new TiempoConstruccion(2); // 2 segundos
